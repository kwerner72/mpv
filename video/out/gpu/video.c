...
static const struct gl_video_opts gl_video_opts_def = {
    ...
    .tone_map = {
        ...
        .scene_threshold_avg = 1.0,
        .scene_threshold_high = 1.0,
...
const struct m_sub_options gl_video_conf = {
    .opts = (const m_option_t[]) {
        ...
        {"hdr-peak-percentile", OPT_FLOAT(tone_map.peak_percentile),
            M_RANGE(0.0, 100.0)},
        {"hdr-black-percentile", OPT_FLOAT(tone_map.black_percentile),
            M_RANGE(0.0, 100.0)},
        {"hdr-black-maxadvance", OPT_FLOAT(tone_map.black_maxadvance),
            M_RANGE(0.0, 100.0)},
        {"hdr-peak-decay-rate", OPT_FLOAT(tone_map.decay_rate),
            M_RANGE(0.0, 1000.0)},
        {"hdr-scene-threshold-low", OPT_FLOAT(tone_map.scene_threshold_low),
            M_RANGE(0, 20.0)},
        {"hdr-scene-threshold-avg", OPT_FLOAT(tone_map.scene_threshold_avg),
            M_RANGE(0, 20.0)},
